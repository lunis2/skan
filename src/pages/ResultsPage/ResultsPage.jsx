...
import {ReactComponent as ArrowUpSVG} from "../../assets/img/arrow up.svg";
import {ReactComponent as Picture4SVG} from "../../assets/img/picture4.svg";
...
export default function ResultsPage() {
    ...
    function loadDocuments(indexOf, count = 10, remaining = 10) {
        ...
        PubServ.getDocuments(publicationsList.slice(indexOf, indexOf + count).map(x => x.encodedId))
            .then(response => {
                    ...
                    <section className={styles.documents}>
                        ...
                        <div className={styles.buttons}>
                            {remainingPublications > 0 &&
                                <button className={styles.show_more_button} ref={showMoreBtnRef}
                                        onClick={onShowMoreBtnClick}>Показать больше</button>
                            }
                            <ArrowUpSVG
                                className={remainingPublications > 0 ? styles.up_button : styles.up_button__only}
