...
import {ReactComponent as YandexSVG} from "../../assets/img/yandex.svg";
import {ReactComponent as LockSVG} from "../../assets/img/lock.svg";
import styles from "./AuthWidget.module.scss";
import {useDispatch} from "react-redux";
import AccountServ from "../../services/AccountServ";
...
export default function AuthWidget() {
    ...
    async function onLoginClick() {
        ...
        await AccountServ.login(loginValue, passValue)
            .then(response => {
    ...
    return (
        <article className={styles.parent}>
            ...
            <button className={styles.login_button} ref={loginBtnRef} onClick={onLoginClick}
                    disabled={!isCompleted}>Войти
            </button>
