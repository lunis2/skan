        ...
        <>
            {(isAuth &&
                    <div className={styles.parent__auth}>
                        ...
                        <div className={styles.avatar__wrapper}>
                            <div className={styles.username__wrapper}>
                                <span className={styles.username}>User U.</span>
                                <button className={styles.exit_button} onClick={() => dispatch(setAuth(false))}>Выйти
                                </button>
                            </div>
                ...
                <div className={styles.parent}>
                    <Link to="/error" className={styles.register_button}>Зарегистрироваться</Link>
